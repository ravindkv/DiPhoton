...
#ifdef ppToaaMG_cxx
ppToaaMG::ppToaaMG(TTree *tree) : fChain(0) 
{
...
Int_t ppToaaMG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ppToaaMG::LoadTree(Long64_t entry)
{
...
void ppToaaMG::Show(Long64_t entry)
{
...
Int_t ppToaaMG::Cut(Long64_t entry)
{

...
// Fri Apr  7 14:21:43 2017 by ROOT version 5.34/36
// from TTree Delphes/Analysis tree
// found on file: Delphe_HEPMC_ggToaa_QCD_100K.root
//////////////////////////////////////////////////////////

#ifndef ggToaaDelphe_h
#define ggToaaDelphe_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 3951;
   const Int_t kMaxTrack = 190;
   const Int_t kMaxTower = 507;
   const Int_t kMaxEFlowTrack = 190;
   const Int_t kMaxEFlowPhoton = 266;
   const Int_t kMaxEFlowNeutralHadron = 243;
...
public :
   ...
   ggToaaDelphe(TTree *tree=0);
   virtual ~ggToaaDelphe();
...
#ifdef ggToaaDelphe_cxx
ggToaaDelphe::ggToaaDelphe(TTree *tree) : fChain(0) 
{
...
ggToaaDelphe::~ggToaaDelphe()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ggToaaDelphe::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ggToaaDelphe::LoadTree(Long64_t entry)
{
...
void ggToaaDelphe::Init(TTree *tree)
{
...
void ggToaaDelphe::Show(Long64_t entry)
{
...
Int_t ggToaaDelphe::Cut(Long64_t entry)
{

...
// Fri Apr  7 13:01:37 2017 by ROOT version 5.34/36
// from TTree Delphes/Analysis tree
// found on file: MGv252_HEPMC_ggToaa_QCD_100K.root
//////////////////////////////////////////////////////////
...
#ifdef ggToaaMG_cxx
ggToaaMG::ggToaaMG(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MGv252_HEPMC_ggToaa_QCD_100K.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MGv252_HEPMC_ggToaa_QCD_100K.root");
      }
...
Int_t ggToaaMG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ggToaaMG::LoadTree(Long64_t entry)
{
...
void ggToaaMG::Show(Long64_t entry)
{
...
Int_t ggToaaMG::Cut(Long64_t entry)
{
